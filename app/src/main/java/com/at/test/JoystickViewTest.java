...
public class JoystickViewTest extends View
        implements
        Runnable {
    ...
    */
     ...
     */
    public JoystickViewTest(Context context) {
        this(context, null);
    }


    public JoystickViewTest(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs);
    }
     ...
     */
    public JoystickViewTest(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if (mAutoReCenterButton) {
                ...
                if (mCallback != null) {
                    mCallback.onMove(getAngle() - 1, getStrength() - 1);
